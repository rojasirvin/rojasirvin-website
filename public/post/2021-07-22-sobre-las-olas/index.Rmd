...
fig.curve <- cases.sintomas.nal %>% 
  ...
  labs(title = titledate.curva,
       caption="Fuente: elaborado por @rojasirvin con datos de la Secretaria de Salud.\nNota: se emplean datos hasta el 27 de junio de 2021 para estimar la media móvil y el spline.")+
...
fig.cases <- cases.sintomas.nal %>% 
  ...
  geom_text(aes(x=2, label="19 de septiembre de 2020", y=5300), color="black", size=2, hjust="left")+
  geom_text(aes(x=2, label="15 de mayo de 2021", y=2600), color="black", size=2, hjust="left")+
...
fig.cases.index <- cases.sintomas.nal %>% 
  ...
  scale_linetype_manual(values=c("solid","solid"))+
  geom_vline(xintercept = 0, color="black", linetype="dotted")+
  geom_text(aes(x=2, label="Segunda ola: 19 de septiembre de 2020\nTercera ola: 15 de mayo de 2021", y=120), color="black", size=2, hjust="left")+
...
fig.deaths <- deaths.nal %>% 
  ...
  scale_linetype_manual(values=c("solid","solid"))+
  geom_vline(xintercept = 0, color="black", linetype="dotted")+
  geom_text(aes(x=2, label="19 de septiembre de 2020", y=450), color="black", size=2, hjust="left")+
  geom_text(aes(x=2, label="15 de mayo de 2021", y=150), color="black", size=2, hjust="left")+
...
Los últimos datos oficiales muestran una tendencia creciente de los casos de covid-19 en México y en muchos países del mundo. Si bien este aumento no puede ser ignorado, sí vale la pena comparar no solo el incremento de casos, sino cómo los casos se han desarrollado y cuál ha sido su desenlace. Por ejemplo.

Usando los datos oficiales de casos al 25 de julio, suavizados con un promedio móvil de siete días, podemos estimar las fechas de inicio de la segunda y tercera oleadas de contagio. Estimé un spline, que permite trazar una curva suave a los datos, obteniendo que las fechas de inicio de la segunda y tercera ola son, respectivamente, el 20 de septiembre de 2020 y el 14 de mayo de 2021.
...
El número de casos en la tercera oleada crece acelaradamente y en las últimas semanas presenta una tendencia muy parecida a la segunda oleada. Los casos 
